    ...
    return axiosInternal
      ...
      .then(result => {
        ...
        return widgets.map(val => {
          ...
          endpoint.card_url = `${val.endpoint[0].replace('http://0.0.0.0', 'http://localhost')}/_info/card/${pathEnd}`
          endpoint.enter_url = `${val.endpoint[0].replace('http://0.0.0.0', 'http://localhost')}/_info/enter/${pathEnd}`
          endpoint.help_url = `${val.endpoint[0].replace('http://0.0.0.0', 'http://localhost')}/_info/help/${pathEnd}`
